...
function withAuthentication(_a) {
    ...
    return function (ComposedComponent) {
        var WithAuthentication = /** @class */ (function (_super) {
            __extends(WithAuthentication, _super);
            function WithAuthentication() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            WithAuthentication.getInitialProps = function (ctx) {
            ...
            WithAuthentication.prototype.render = function () {
                // console.log("WithAuthentication#render", this.props);
                return __assign({}, this.props) /  > ;
            };
            WithAuthentication.displayName = "WithAuthentication(" + ComposedComponent.displayName + ")";
            WithAuthentication.propTypes = {};
            WithAuthentication = __decorate([
